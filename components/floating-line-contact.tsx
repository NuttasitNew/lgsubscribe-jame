...
export function FloatingLineContact() {
  ...
  return (
    <aside
      className="fixed bottom-6 right-6 z-[55] hidden select-none lg:block"
      aria-label="ติดต่อฝ่ายขายทาง LINE"
    >
      <div className="relative">
        ...
        >
          <span className="relative grid size-10 shrink-0 place-items-center rounded-full bg-white text-[#06C755]">
            <span
              aria-hidden="true"
              className="absolute inset-0 animate-ping rounded-full bg-white/60 [animation-duration:2.5s]"
            />
