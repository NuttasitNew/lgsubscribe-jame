...
export const metadata: Metadata = createPageMetadata({
  title: "เงื่อนไข LG Subscribe สัญญากี่ปี ครบสัญญา และย้ายบ้าน",
  description: "สรุปเงื่อนไข LG Subscribe ที่คนค้นหาบ่อย: ระยะสัญญา การตรวจเครดิต ผิดนัด คืนสินค้า ย้ายบ้าน และบริการหลังครบสัญญา",
  path: "/terms/",
});
...
const topics = [
  ...
  { icon: "/images/generated/icon-delivery-v1.webp", title: "ย้ายบ้านหรือย้ายเครื่อง", text: "สัญญากำหนดสถานที่ติดตั้งไว้ การย้ายอาจกระทบสิทธิบริการ จึงควรแจ้งบริษัทก่อนย้าย" },
];
    ...
    <>
      ...
      <header className="page-hero">
        <div className="container-page max-w-5xl">
          ...
          <h1 className="mt-4 text-4xl font-bold leading-tight sm:text-5xl">เงื่อนไข LG Subscribe สัญญากี่ปี และต้องอ่านอะไรบ้าง?</h1>
        ...
        <div className="container-page max-w-6xl">
          ...
          <div className="mt-12 rounded-2xl bg-neutral-950 p-8 text-white">
            ...
            <ol className="mt-5 grid gap-3 text-white/70 md:grid-cols-2">
              ...
              <li>2. สถานที่ติดตั้งและเงื่อนไขย้ายบ้าน</li>
