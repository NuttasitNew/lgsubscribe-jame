    ...
    <>
      ...
      <header className="page-hero">
        <div className="container-page max-w-5xl">
          ...
          <Button asChild size="lg" className="mt-8 bg-[#06C755] text-neutral-950 hover:bg-[#06C755]/90">
            <a href={siteConfig.lineUrl} target="_blank" rel="noreferrer">
              <LineMark className="size-5 text-white" /> เพิ่มเพื่อน LINE {siteConfig.lineId}
            </a>
          </Button>
        </div>
      </header>
      ...
      <section className="section-space">
        <div className="container-page">
          ...
          <div className="mt-10 rounded-2xl border border-[#06C755]/20 bg-[#f3fff6] p-7 sm:p-9">
            ...
            <Button asChild size="lg" className="mt-6 bg-[#06C755] text-neutral-950 hover:bg-[#06C755]/90">
              <a href={siteConfig.lineUrl} target="_blank" rel="noreferrer">
                <LineMark className="size-5 text-white" /> เพิ่มเพื่อน LINE
              </a>
            </Button>
          </div>
        </div>
