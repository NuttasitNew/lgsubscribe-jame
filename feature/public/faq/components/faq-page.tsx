...
export const metadata: Metadata = createPageMetadata({
  title: "คำถาม LG Subscribe ดีไหม ไม่มีบัตรเครดิต และเครดิตบูโร",
  description: "รวมคำถามที่คนค้นหาเกี่ยวกับ LG Subscribe: คืออะไร ดีไหม คุ้มไหม สัญญากี่ปี ไม่มีบัตรเครดิต สมัครอย่างไร เครดิตบูโร ครบสัญญา ซ่อม และย้ายบ้าน",
  path: "/faq/",
});
...
const allFaqs = [
  ...
  { q: "LG Subscribe ดีไหม และคุ้มไหม?", a: "เหมาะกับผู้ที่ต้องการกระจายค่าใช้จ่ายและให้ความสำคัญกับบริการดูแล ความคุ้มควรพิจารณาจากยอดชำระรวม ระยะสัญญา และรายการบริการเทียบกับทางเลือกอื่น" },
  ...
  { q: "LG Subscribe เชื่อถือได้ไหม หรือเป็นมิจฉาชีพ?", a: "LG Subscribe เป็นบริการสมัครใช้สินค้าแบบรายเดือน แต่ผู้ขายหรือโฆษณาแต่ละรายต้องตรวจสอบแยกกัน ควรเช็กโดเมน ข้อมูลบริษัท บัญชีรับเงิน และเอกสารสัญญาก่อนส่งข้อมูลหรือชำระเงิน" },
      ...
      <section className="section-space">
        <div className="container-page max-w-4xl">
          ...
          <div className="mt-10 rounded-2xl border border-red-100 bg-red-50 p-7">
            ...
            <p className="mt-3 leading-7 text-red-950/75">คำตอบในหน้านี้เป็นสรุปเพื่อการตัดสินใจ ให้ยึดเอกสารที่บริษัทออกให้และเงื่อนไขในสัญญาฉบับเต็มเป็นหลัก</p>
