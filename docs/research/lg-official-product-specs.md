...
4. PDP รุ่นเก่าบางหน้า (`FV1413H4M`, `WS510SN`) ไม่มี full-spec rows ใน HTML ปัจจุบัน ให้ใช้เฉพาะชื่อรุ่นและ feature copy ที่หน้า LG ระบุ ห้ามเติมค่าจากรุ่นใกล้เคียง
...
จาก actual 48 URLs: พบ product schema 47, full-spec table 45, และ `additionalProperty` ใช้เป็น key specs ได้เพียง 27; นี่คือเหตุผลที่ห้ามพึ่ง JSON-LD อย่างเดียว สามหน้าที่ไม่มี full table คือ legacy PDP `FV1413H4M`, legacy PDP `WS510SN` และ generic `/th/subscribe/` ที่โค้ดผูกให้ `WD110AN`
...
| `RC90V9AV2W` | `EXACT-LG-OTHER` (Portugal)                  | dryer 9 kg; 600 × 850 × 660 mm; 57 kg; Dual Inverter Heat Pump; auto-clean condenser; EU energy class C; 175 kWh/year; 62 dBA; Wi-Fi | [LG Portugal — RC90V9AV2W](https://www.lg.com/pt/tratamento-roupa/maquinas-de-secar-roupa/rc90v9av2w/) |
...
| รหัส route | Status / official model                                  | สเปกที่ยืนยันจาก LG                                                                                                                                               | Official source                                                                                                                                                                                                                                                                                                                                                                   |
| ---------- | -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `WS510SN`  | `EXACT-TH`; legacy PDP has no full-spec rows             | floor-standing; cold-water tank 7.5 L; 4-stage filter; 270 mm dispensing clearance; drip tray 1.9 L; Smart Inverter Compressor; compressor part warranty 10 years | [LG Thailand — WS510SN](https://www.lg.com/th/water-purifiers/ws510sn/)                                                                                                                                                                                                                                                                                                           |
